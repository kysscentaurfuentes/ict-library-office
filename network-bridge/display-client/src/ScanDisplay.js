...
const ScanDisplay = () => {
    ...
    useEffect(() => {
        if (window.electronAPI) {
            const unsubscribe = window.electronAPI.onScanResult((result) => {
    ...
    const handleKeyDown = (e) => {
        ...
        const isScannerInput = e.key !== "Enter" && e.key.length === 1 && /[0-9]/.test(e.key);
        if (isScannerInput) {
            scannerBufferRef.current += e.key;
            // para hindi lumabas sa input field bawat digit
            e.preventDefault();
            console.log(`Appending to buffer: "${e.key}". Current buffer: "${scannerBufferRef.current}"`);
            // ✅ AUTO PROCESS (kahit walang Enter)
            if (scannerBufferRef.current.length === 8) {
                console.log("Auto-processing (scanner, no Enter):", scannerBufferRef.current);
            ...
            const valueToProcess = scannerBufferRef.current || inputValue.replace(/[^0-9]/g, "");
    ...
    return (_jsxs("div", { style: {
            ...
            position: "relative",
            overflow: "hidden",
        }, children: [_jsxs(Helmet, { children: [_jsx("title", { children: "CSU ICT Library Attendance" }), _jsx("meta", { name: "description", content: "Attendance logging via QR scanning at CSU Library" }), _jsx("meta", { name: "viewport", content: "width=device-width, initial-scale=1" }), _jsx("link", { rel: "icon", href: CSULogo })] }), _jsx("style", { children: `
          html, body {
            margin: 0;
            padding: 0;
            overflow: hidden;
          }
        ` }), _jsx("img", { src: LibraryLogo, alt: "Library Logo", style: {
                    position: "absolute",
                    top: 20,
                    left: 20,
                    width: 100,
                    height: "auto",
                    zIndex: 10,
                } }), _jsx("img", { src: CSULogo, alt: "CSU Logo", style: {
                    position: "absolute",
                    top: 20,
                    right: 20,
                    width: 100,
                    ...
                    position: "relative",
                    zIndex: 10,
                }, children: [_jsx("h1", { style: { fontSize: "2.5em", marginBottom: 10 }, children: "Caraga State University" }), _jsx("h2", { style: { fontSize: "1.5em", fontWeight: "normal" }, children: "Ampayon, Butuan City" }), _jsx("h3", { style: { fontSize: "1.8em", fontWeight: "normal" }, children: "Library ICT Office Occupancy And Attendance Monitoring System" }), _jsx("p", { style: { marginTop: 30, fontSize: "1.2em" }, children: "Please scan your QR code below" })] }), _jsxs("div", { style: {
                    textAlign: "center",
                    marginTop: 50,
                    position: "relative",
                    zIndex: 10,
                }, children: [_jsx("h3", { style: { fontSize: "1.5em", marginBottom: "20px" }, children: "Scan & Log Attendance" }), _jsx("p", { style: { color: "#ccc", marginBottom: "15px" }, children: "Point your QR Code to the scanner or type your ID." }), _jsx("div", { style: { position: "relative", display: "inline-block" }, children: _jsx("input", { ref: inputRef, type: "text", value: inputValue, onChange: handleInputChange, onKeyDown: handleKeyDown, style: {
                                padding: "15px",
                                fontSize: "1.2em",
                                borderRadius: "10px",
                                ...
                                backgroundColor: "#fff",
                                color: "#333",
                            }, placeholder: "ex. 211-01850", autoFocus: true }) })] }), _jsxs("div", { style: {
                    textAlign: "center",
                    marginTop: 50,
                    position: "relative",
                    zIndex: 10,
                }, children: [isLoading && !data && (_jsx("p", { style: { fontSize: "1.5em" }, children: "Processing scan..." })), !isLoading && !data && (_jsxs(_Fragment, { children: [_jsxs("p", { style: { fontSize: "1.5em" }, children: ["Waiting for scan", _jsxs("span", { className: "loading-dots", children: [_jsx("span", { children: "." }), _jsx("span", { children: "." }), _jsx("span", { children: "." })] })] }), _jsx("div", { className: "torus-container", children: _jsxs("div", { className: "scene3d", children: [_jsx("div", { className: "torus-core", children: Array.from({ length: 36 }).map((_, i) => (_jsx("div", { className: "torus-segment", style: { "--i": i } }, `torus-${i}`))) }), _jsxs("div", { className: "springs-system", children: [_jsx("div", { className: "coil-spring spring-1" }), _jsx("div", { className: "coil-spring spring-2" }), _jsx("div", { className: "coil-spring spring-3" }), _jsx("div", { className: "coil-spring spring-4" }), _jsx("div", { className: "coil-spring spring-5" })] })] }) })] })), data && (_jsx("div", { style: {
                        ...
                        }, children: data.status === "success" ? (_jsxs(_Fragment, { children: [_jsx("h2", { children: "\u2705 Scan Successful" }), _jsxs("p", { children: [_jsx("strong", { children: "Name:" }), " ", data.name] }), _jsxs("p", { children: [_jsx("strong", { children: "ID:" }), " ", formatStudentId(data.student_id)] }), _jsxs("p", { children: [_jsx("strong", { children: "Course:" }), " ", data.course] }), _jsxs("p", { children: [_jsx("strong", { children: "Time-In:" }), " ", data.time] }), _jsxs("p", { children: [_jsx("strong", { children: "Date:" }), " ", data.date] })] })) : (_jsxs(_Fragment, { children: [_jsx("h2", { children: "\u274C Scan Failed" }), _jsx("p", { children: data.message }), _jsxs("p", { children: [_jsx("strong", { children: "ID:" }), " ", formatStudentId(data.student_id)] })] })) }))] }), _jsx("style", { children: `
      .spinner {
