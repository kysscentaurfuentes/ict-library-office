...
export default function HomeScreen() {
 ...
 return (
  <div style={{ 
    ...
    height: '100vh',
    width: '100%', /* Sinasakop ang buong natitirang espasyo sa tabi ng sidebar */
    overflow: 'hidden',
    boxSizing: 'border-box'
  }}>
    
    {/* Pangunahing content container na aakupahan ang lahat ng space */}
    <div style={{ 
      flex: 1, 
      height: '100vh',
      padding: '25px 35px', 
      ...
      {/* Menu Grid - Ibinalik sa tamang ratio para sakupin ang buong lapad */}
      {/* Row 1 */}
      <div style={{
        display: 'grid',
      ...
      {/* Footer */}
      <div style={{
        marginTop: 'auto', /* Pinapanatili ang footer sa pinakailalim ng screen */
        paddingTop: '20px',
        paddingBottom: '10px',
        textAlign: 'center',
        borderTop: `1px solid ${isDarkMode ? '#334155' : '#e2e8f0'}`,
