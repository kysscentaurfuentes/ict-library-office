...
const courses = [
  ...
  'DOCTOR OF PHILOSOPHY IN MATHEMATICS EDUCATION (PHD-MATHED)',
  'DOCTOR OF PHILOSOPHY IN SCIENCE EDUCATION (PHD-SCIED)',
  'DOCTOR OF PHILOSOPHY MAJOR IN SCIENCE EDUCATION WITH SPECIALIZATION IN BIOLOGY (PHD SCIED BIO)',
  'DOCTOR OF PHILOSOPHY MAJOR IN SCIENCE EDUCATION WITH SPECILIZATION IN PHYSICS (PHD SCIED PHYS)',
  'MASTER IN ENVIRONMENTAL MANAGEMENT (MEM)',
  'MASTER OF ARTS IN EDUCATION WITH SPECIALIZATION IN EDUCATIONAL MANAGEMENT (MAED-EM)',
  'MASTER OF ARTS IN EDUCATION WITH SPECIALIZATION IN ENGLISH LANGUAGE TEACHING (MAED-ELT)',
  'MASTER OF ARTS IN EDUCATION WITH SPECIALIZATION IN GUIDANCE & COUNSELING (MAED-GC)',
  'MASTER OF ARTS IN GUIDANCE AND COUNSELING (MAGC)',
  'MASTER OF SCIENCE EDUCATION WITH SPECIALIZATION IN BIOLOGICAL SCIENCES (MSciEd-BIO)',
  'MASTER OF SCIENCE EDUCATION WITH SPECIALIZATION IN PHYSICAL SCIENCES (MSCIED-PHYS)',
  ...
  'MASTER OF ARTS IN EDUCATION WITH SPECIALIZATION IN TEACHING READING AND LITERATURE (MAED-TRL)',
